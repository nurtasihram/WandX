...
#define wapi_reflect_true1(name)              constexpr ReflectTrue<ThisFile, LiString(#name), ::name> name
#define wapi_reflect_true2(name, new_ret)     constexpr ReflectTrue<ThisFile, LiString(#name), ::name, new_ret> name
#define wapi_reflect_true(...)                mx_funcN(wapi_reflect_true, __VA_ARGS__)

/* Macro Windows API bool reflectors W/A Overload In One */
#define wapi_reflect_true_WAO1(name)          constexpr WaReflectorOf<ThisFile, LiString(#name), ::name##W, ::name##A> name
#define wapi_reflect_true_WAO2(name, new_ret) constexpr WaReflectorOf<ThisFile, LiString(#name), ::name##W, ::name##A, new_ret> name
#define wapi_reflect_true_WAO(...)            mx_funcN(wapi_reflect_true_WAO, __VA_ARGS__)

/* Macro Windows API bool reflectors A Version */
#define wapi_reflect_true_A1(name)            wapi_reflect_true1(name##A)
#define wapi_reflect_true_A2(name, new_ret)   wapi_reflect_true2(name##A, new_ret)
#define wapi_reflect_true_A(...)              mx_funcN(wapi_reflect_true_A, __VA_ARGS__)
/* Macro Windows API bool reflectors W Version */
#define wapi_reflect_true_W1(name)            wapi_reflect_true1(name##W)
#define wapi_reflect_true_W2(name, new_ret)   wapi_reflect_true2(name##W, new_ret)
#define wapi_reflect_true_W(...)              mx_funcN(wapi_reflect_true_W, __VA_ARGS__)
/* Macro Windows API bool reflectors W&A Versions */
#define wapi_reflect_true_WA1(name)           wapi_reflect_true1(name##W); \
											  wapi_reflect_true1(name##A)
#define wapi_reflect_true_WA2(name, new_ret)  wapi_reflect_true2(name##W, new_ret); \
											  wapi_reflect_true2(name##A, new_ret)
#define wapi_reflect_true_WA(...)             mx_funcN(wapi_reflect_true_WA, __VA_ARGS__)
/* Macro Windows API bool reflectors W&A Versions With Template Selector */
#define wapi_reflect_WAT(name)			      template<bool IsUnicode = WX::IsUnicode> \
											  constexpr auto name = ConditionOfValue<IsUnicode, name##A, name##W>;
#define wapi_reflect_true_WAT1(name)          wapi_reflect_true_WA1(name); \
											  wapi_reflect_WAT(name)
#define wapi_reflect_true_WAT2(name, new_ret) wapi_reflect_true_WA2(name, new_ret); \
											  wapi_reflect_WAT(name)
#define wapi_reflect_true_WAT(...)            mx_funcN(wapi_reflect_true_WAT, __VA_ARGS__)

/* Macro Windows API validated handle reflectors */
#define wapi_reflect_valid(name)              constexpr ReflectValidHandle<ThisFile, LiString(#name), ::name> name

/* Macro  */
#define wapi_reflect_proto(name)              constexpr auto name = ::name;
